...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{
			Name:   "new-tag",
			Value:  "",
			Usage:  "Add a new tag to the release",
			EnvVar: "PLUGIN_NEW_TAG,GITEA_RELEASE_NEW_TAG",
		},
		cli.StringFlag{
			Name:   "tag-time-format",
			Value:  "20060102-150405",
			Usage:  "Time format for the release tag",
			EnvVar: "PLUGIN_TAG_TIME_FORMAT,GITEA_RELEASE_TAG_TIME_FORMAT",
		},
		cli.StringFlag{
			Name:   "tag-date-format",
			Value:  "20060102",
			Usage:  "Date format for the release tag",
			EnvVar: "PLUGIN_TAG_DATE_FORMAT,GITEA_RELEASE_TAG_DATE_FORMAT",
		},
		cli.StringFlag{
			Name:   "display-time-format",
			Value:  "2006-01-02T15:04:05Z",
			Usage:  "Time format for the release title",
			EnvVar: "PLUGIN_DISPLAY_TIME_FORMAT,GITEA_RELEASE_DISPLAY_TIME_FORMAT",
		},
		cli.StringFlag{
			Name:   "display-date-format",
			Value:  "2006-01-02",
			Usage:  "Date format for the release title",
			EnvVar: "PLUGIN_DISPLAY_DATE_FORMAT,GITEA_RELEASE_DISPLAY_DATE_FORMAT",
		},
		cli.StringFlag{
			Name:   "repo.owner",
...
func run(c *cli.Context) error {
	...
	plugin := Plugin{
		...
		Config: Config{
			...
			Note:              c.String("note"),
			NewTag:            c.String("new-tag"),
			TagTimeFormat:     c.String("tag-time-format"),
			TagDateFormat:     c.String("tag-date-format"),
			DisplayTimeFormat: c.String("display-time-format"),
			DisplayDateFormat: c.String("display-date-format"),
		},
	}
